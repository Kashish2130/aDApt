...
const SharedResLibPage = () => {
  const [categories, setCategories] = useState([
    { id: "books", name: "Books", items: [] },
    { id: "notes", name: "Notes", items: [] },
    { id: "lab_materials", name: "Lab Materials", items: [] },
  ...
  return (
    <div className="flex h-screen bg-[#F5F0CD]">
      ...
      <div className="flex-1 p-10">
        <h1 className="text-3xl font-bold text-gray-900">Shared Resource Library</h1>
        {selectedCategory ? (
